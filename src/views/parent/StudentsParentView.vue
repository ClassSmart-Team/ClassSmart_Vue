...
const myChildren = ref([
  {
    ...
    status: 'Activo',
    schedule: [
      { day: 'Lunes', subject: 'Matemáticas IV', time: '07:00 - 09:00' },
      { day: 'Miércoles', subject: 'Física II', time: '09:00 - 11:00' },
      { day: 'Viernes', subject: 'Programación I', time: '07:00 - 09:00' },
    ],
  },
  {
    id: 2,
    ...
    status: 'Activo',
    schedule: [
      { day: 'Martes', subject: 'Historia Universal', time: '11:00 - 13:00' },
      { day: 'Jueves', subject: 'Química Orgánica', time: '08:00 - 10:00' },
    ],
  },
])
