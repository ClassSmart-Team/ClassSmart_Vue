...
<template>
  <SidebarLayout>
    ...
    <div v-else-if="error" class="error-banner">
      <span>⚠</span><p>Error al cargar la tarea.</p>
    </div>
...
.header-text h1 { font-size: 1.4rem; margin: 0 0 6px 0; }
.header-text p  { font-size: 0.82rem; opacity: 0.85; margin: 0; }
.time-chip {
...
.time-chip.urgent { background: #fef3c7; color: #92400e; }
...
/* SUBMISSION */
.submission-section { border-top: 5px solid #e2e8f0; }
.submission-section.graded    { border-top-color: #10b981; }
.submission-section.submitted { border-top-color: #f59e0b; }
...
.submission-header h3 { margin: 0 0 6px 0; font-size: 1.1rem; color: #1e293b; }
...
.feedback-box strong { font-size: 0.88rem; color: #15803d; }
.feedback-box p { margin: 8px 0 0 0; color: #374151; line-height: 1.6; }
...
.upload-area:hover { border-color: var(--color-Azul); background: #f0f7ff; }
.hidden-input { display: none; }
.upload-icon  { font-size: 2rem; display: block; margin-bottom: 10px; }
.upload-placeholder p { margin: 0; color: #374151; font-weight: 600; }
.upload-hint { font-size: 0.78rem; color: #94a3b8; margin-top: 6px; display: block; }
.upload-selected {
  display: flex;
  align-items: center;
...
.btn-submit:disabled,
.btn-clear:disabled { opacity: 0.55; cursor: not-allowed; }
