...
import { requestForToken } from '@/services/notificationService.ts'
      ...
      <div class="main-content-grid">
        <div class="content-column">
          ...
          <div v-else class="groups-list">
            ...
            <div v-if="!groupsData?.data?.length" class="empty">
              No estás inscrito en ningún grupo aún.
            </div>
          </div>
        </div>
        ...
        <div class="content-column">
          ...
          <div class="announcements-list">
            <div
              v-for="notif in notificationsData?.data?.slice(0, 4)"
              :key="notif.id"
              class="ann-item"
            ...
            >
              ...
              <p class="ann-text">
                {{
                  notif.data?.message ||
                  notif.content ||
                  'Tienes una nueva notificación en la plataforma.'
                }}
              </p>
            </div>
            <div v-if="!notificationsData?.data?.length" class="empty">
