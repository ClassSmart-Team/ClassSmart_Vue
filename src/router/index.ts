...
import HomeParentView from '@/views/parent/HomeParentView.vue'
import ProfileParentView from '@/views/parent/ProfileParentView.vue'
import StudentsParentView from '@/views/parent/StudentsParentView.vue'
import GroupsParentView from '@/views/parent/GroupsParentView.vue'
import TasksParentView from '@/views/parent/TasksParentView.vue'
import ForumParentView from '@/views/parent/ForumParentView.vue'
import GradesParentView from '@/views/parent/GradesParentView.vue'
import NotificationParentView from '@/views/parent/NotificationParentView.vue'
import SettingsParentView from '@/views/parent/SettingsParentView.vue'
import ShowGroup from '@/views/parent/ShowGroup.vue'
import TaskDetailView from '@/views/parent/TaskDetailView.vue'
import ForumDetailView from '@/views/parent/ForumDetailView.vue'
